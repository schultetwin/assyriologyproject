...
<ul class="menu">
            <li>
                <a href="documentation2.html" style="font-size: 2vw; height:20px">Documentation</a>
            </li>
            <li>
                <a href="firstsign.html" style="font-size: 2vw;">About the first sign</a>
            </li>
            <li>
                <a href="secondsign.html"style="font-size: 2vw;" >About the second sign</a>
            </li>
        </ul>
    </header>
...
<p><i>This is a work in progress.  The Kanesh, Old Babylonian, and Neo-Babylonian sections are advanced versions.    The Nuzi section will be updated once I find a list of logograms used in Nuzi.  In any event, all sections can be used to look up signs.</i></p>  
             ...
             <p style ="text-align:center; font-size: 2vw;">The following two signs are illustrations of how this systems works: </p>
              ...
              <p style ="text-align:center; font-size:2vw">Try it. Look up this first sign in the                     Kanesh signs.</p> 
          ...
          <div class="container" >
            ...
            <g>
               ...
               <g>
                    ...
                    <circle cx="12" cy="12" r="4" style="fill:#00ff00" />
               </g>

               <g>
                    <title>NEC: A northeast corner connector </title>
                    <circle cx="100" cy="12" r="4" style="fill:#00ff00" />
               </g>

               <g>
                     <title>SEC: A southeast corner connector </title>
                     <circle cx="100" cy="100" r="4" style="fill:#00ff00" />
               </g>

               <g>
                     <title>SWC: A southwest corner connector </title>
                     <circle cx="12" cy="100" r="4" style="fill:#00ff00" />
               </g>
           </g>
                            </svg>
                      </div>
...
<!-- THE FORM  The action is "" because we want to execute the php script at the top of this page when the submit button below is pushed. -->
<div style="align-text:center">
	<form action="" method="POST">
		<p style= "text-align:center; font-size: 2vw;">
		To look up a sign select a class of signs below, click on Submit, </p> 
		<p style="text-align: center; font-size: 2vw;">
		and then enter your counts on the resulting new page.</p>

<div style="text-align:center">

                       <input type="radio" id="contactChoice1" name="signclass" value="1" checked>
                       <label for="contactChoice1"><span font-size="2vw">Kanesh, Old Assyrian                                                                       </span></label><br>
                     ...
                     <label for="contactChoice3">Old Babylonian</label><br>

                     <input type="radio" id="contactChoice4" name="signclass" value="4">
                     <label for="contactChoice4">Neo Babylonian</label><br><br>
