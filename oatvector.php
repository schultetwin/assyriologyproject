...
/*           */
	...
	echo "<br>";
	echo "The id of this candidate in the Old Assyrian table is   " . $output['xvectorvals']["id"];
	echo "<br>";
...
/*REMOVE EVERY ELEMENT IN $array2 WITH A KEY THAT IS NOT A VALUE IN $oatheorder.  REMEMBER $oatheorder IS AN INDEXED ARRAY.  THERE ARE JUST TWO: MAXDT AND submit.      */
$array2 = array_intersect_key($array2, array_flip($oatheorder));
/* array_flip interchanges keys and values. NOW the set of keys of $array2 is the same as the set of values of $oatheorder WE CAN NOW USE $oatheorder TO REORDER $array2 */
$array2 = array_merge(array_flip($oatheorder), $array2);
/* THE ABOVE LINE IS EXPLAINED BELOW. */


/* NOW WE REMOVE EVERY ELEMENT IN $array1 WITH A KEY THAT IS NOT A KEY IN $array2.  JUST THE COUNTS REMAIN. */
...
/* IF THE Modify SUBMIT BUTTON IS PUSHED, THE STRING $xencoded IS SENT TO OAeditingpage IN $_POST WHERE IT WILL BE base64_decode  and UNSERIALIZED. */
	
echo "
<form  method = 'POST' action = 'OAeditingpage.php' /> 
