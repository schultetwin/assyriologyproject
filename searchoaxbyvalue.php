...
$query = "SELECT  *   FROM oaxvectors WHERE cleanedvalue(value) COLLATE utf8mb4_0900_as_cs  LIKE '%$searchbyvalue%' ";
...
$array1 = $row;
/*The following results in $array1 keeping only those keys that are values in $oatheorder.  */
$array1 = array_intersect_key($array1, array_flip($oatheorder)); 
/*Next we insure that $array1 is in the proper order.      */  
$array1 = array_merge(array_flip($oatheorder),  $array1);
