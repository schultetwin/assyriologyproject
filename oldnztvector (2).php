...
<p>
The tvector count--the input--is, of course, the same in each of the outputs.  MAXDT is included here as a reference.  
</p>
<p>
...
/* NEXT IS AN IMPORTANT PART OF THIS SCRIPT.  ONE ROW AT A TIME IS READ FROM THE TABLE nzxvectors AND ITS DISTANCE FROM THE INPUT IS CALCULATED.  IF THIS DISTANCE IS LESS THAN OR EQUAL TO MAXDT, THIS ROW IS USED TO CONSTRUCT AN OUTPUT.*/
...
/* WE WANT TO SEND $output['xvectorvals'] TO NZeditingpage, BUT  CANNOT SEND AN ARRAY SO WE FIRST SERIALIZE IT. BUT THAT IS NOT ENOUGH.  I NEED TO SEND IT AS A HIDDEN VARIABLE, AND SERIALIZED VARIABLES CANNOT BE HIDDEN SO I HAVE TO base64_encode IT.  $xoutput IS A STRING THAT I CAN SEND AS A HIDDEN VARIABLE. */
